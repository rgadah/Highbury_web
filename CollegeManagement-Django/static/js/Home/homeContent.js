...
import image6 from './ok3.png';
import image7 from './bo.png';
import image8 from './tr.png';
import image9 from './ma.png';
import image10 from './abou.jpg';
import image11 from './chem.png';
import image12 from './mech.png';
import image13 from './elect.png';
import image14 from './civ.png';
import image15 from './cyber.png';
import image16 from './datas.png';
import image17 from './fstack.png';
import image18 from './webdev2.png';
import image19 from './ma.png';
import image20 from './ma.png';
import image21 from './testi1.png';
import image22 from './testi2.png';
import heroimage from './eng2.png';
import headimage1 from './HighLogoRes-01.png';
...
import image29 from './t9.png';
import image30 from './t12.png';
import image31 from './t13.png';
import image32 from './t8.png';
                ...
                <div class="container py-1" >
                    <div class="row justify-content-center align-items-center" id="row1">
                        <div class="col-auto image-col">
                            <img src="${headimage1}" alt="Engineering Studies" width="200px" >
                        </div>
            ...
            <div class="container">
                ...
                <div id="container1" class="container row g-4">
                    <div class="row row-cols-1 row-cols-md-4 g-4">
                        ...
                        <div class="col">
                            <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image8}" class="card-img-top" alt="Hands-on Training" width="200px">
                            <div class="card-body text-center">
                ...
                <div id="container2" class="container row g-4" style="display: none;">
                    ...
                    <div class="row row-cols-1 row-cols-md-4 g-4 mt-4">
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image11}" class="card-img-top" alt="Chemical Engineering" width="200px">
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image13}" class="card-img-top" alt="Electrical Engineering" width="200px">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                            National N Diploma
                            </h6>
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image14}" class="card-img-top" alt="Civil Engineering" width="200px">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                            National N Diploma
                            </h6>
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image12}" class="card-img-top" alt="Mechanical Engineering" width="200px">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                            National N Diploma
                            </h6>
                ...
                <div id="container3" class="container row g-4" style="display: none;">
                    ...
                    <div class="row row-cols-1 row-cols-md-4 g-4 mt-4">
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image15}" class="card-img-top" alt="Cybersecurity Specialization">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image16}" class="card-img-top" alt="Data Science Solutions Developer">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                            Occupational Certificate
                            </h6>
                            ...
                            <div class="mt-auto">
                                <a href="/datascsol" class="btn btn-primary mt-3">Learn more</a>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image17}" class="card-img-top" alt="Full Stack Web and Software Developer">
                            <div class="card-body text-center d-flex flex-column">
                        ...
                        <div class="col">
                        <div class="card h-100 shadow d-flex flex-column">
                            <img src="${image18}" class="card-img-top" alt="IT Technical Support">
                            <div class="card-body text-center d-flex flex-column">
                            <h6 class="card-title fs-9" style="font-family: 'Lora', serif;">
                            Occupational Certificate
                            </h6>
                ...
                <div id="container4" class="container row g-4" style="display: none;">
                        ...
                        <div class="row justify-content-center g-4 mt-4"> 
                            ...
                            <div class="col-12 col-md-5 d-flex justify-content-center">
                                <div class="card h-100 shadow d-flex flex-column" style="width: 210px;">
                                    <img src="${image19}" class="card-img-top mx-auto mt-3" alt="November Matric Rewrite" width="200px">
                                    <div class="card-body text-center d-flex flex-column">
                    ...
                    <div id="container5" class="container row g-4" style="display: none;">
                        ...
                        <div class="row row-cols-1 row-cols-md-4 g-4 mt-4">
                            ...
                            <div class="col">
                                <div class="card h-100 shadow d-flex flex-column">
                                    <img src="${image29}" class="card-img-top" alt="Trade Test Preparation" width="200px">
                                    <div class="card-body text-center d-flex flex-column">
                            ...
                            <div class="col">
                                <div class="card h-100 shadow d-flex flex-column">
                                    <img src="${image30}" class="card-img-top" alt="CoC Unit Standard (Three Phase)" width="200px">
                                    <div class="card-body text-center d-flex flex-column">
                            ...
                            <div class="col">
                                <div class="card h-100 shadow d-flex flex-column">
                                    <img src="${image31}" class="card-img-top" alt="Solar Training Program" width="200px">
                                    <div class="card-body text-center d-flex flex-column">
                            ...
                            <div class="col">
                                <div class="card h-100 shadow d-flex flex-column">
                                    <img src="${image32}" class="card-img-top" alt="PLC Training Program" width="200px">
                                    <div class="card-body text-center d-flex flex-column">
            ...
            <div class="container d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInUp text-center" data-wow-delay="0.1s">
                        <div class="position-relative" style="display: inline-block;">
                            <img class="img-fluid" src="${image10}" alt="Campus Image" style="object-fit: cover; min-height: 400px;">
                        </div>
                    </div>
                    <!-- Text Column -->
