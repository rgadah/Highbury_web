...
nav.innerHTML = `
    <div class="container">
        <a class="navbar-brand desktop-logo" >
            <img src="${Icon}" alt="desktop-logo" class="navbar-logo" onclick="window.location.href='/';" style="cursor: pointer;" >
        </a>
        <ul class="nav nav-tabs justify-content-center">
          ...
          onclick="window.open('http://127.0.0.1:8001/management/', '_blank')"
        >
          Login
        </div>
        </ul>
    ...
    <div class="toggle_btn">
      <a class="navbar-brand mobile-logo" href="/">
        <img src="${Icon2}" alt="mobile-logo" class="navbar-logo">
      </a>
...
const navbar = document.querySelector('.navbar');
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > 50) {
                navbar.style.backgroundColor = 'rgba(135, 206, 250, 0.9)'; // More opaque
