...
import { renderCOCUnitStandardThreePhasePage } from './Home/tphase.js';
...
import { renderCOCUnitStandardSinglePhasePage } from './Home/sphase.js';
...
import {renderElectricalEngineeringArtisanTrainingPage} from './Home/lightc.js';
...
import {renderBasicElectricFencingTrainingPage  } from './Home/fencing.js';
...
import { renderCOCUnitStandardForFencingPage } from './Home/usfencing.js';
import { renderPLCTrainingPage } from './Home/plc.js';
...
const routes = {
    ...
    '/lightcurrent':renderElectricalEngineeringArtisanTrainingPage,
    ...
    '/fencing': renderBasicElectricFencingTrainingPage,
    '/engfaculty':loadengineeringpage,
    '/ITfaculty' : loadcomppage,
    '/trade-courses':loadTradePage,
    '/terms': loadtermspage,
    '/matapp':loadMatricRewriteRegistrationPage, 
    '/usfencing': renderCOCUnitStandardForFencingPage,
    '/plc':renderPLCTrainingPage,
    '/singlephase':renderCOCUnitStandardSinglePhasePage, 
    '/threephase':renderCOCUnitStandardThreePhasePage,
...
window.navigateToHome = function () {
    history.pushState({}, '', '/');
    router(); // Load home content without full page reload
};
